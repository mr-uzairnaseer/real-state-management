...
export function mapProject(p: {
  ...
  return {
    ...
    stageTemplates: (p.stageTemplates as unknown as ConstructionStageTemplate[]) ?? [],
    greyStructure: p.greyStructure as unknown as GreyStructure,
...
export function mapUnit(u: {
  ...
  return {
    ...
    sale: (u.sale as unknown as SaleRecord | null) ?? undefined,
    rental: (u.rental as unknown as RentalRecord | null) ?? undefined,
    booking: (u.booking as unknown as BookingRecord | null) ?? undefined,
    expenses: u.expenses,
    notes: u.notes,
    documents: (u.documents as unknown as DocumentFile[]) ?? [],
    createdAt: u.createdAt.toISOString(),
...
export function mapPlot(p: {
  ...
  return {
    ...
    status: p.status,
    documents: (p.documents as unknown as DocumentFile[]) ?? [],
    notes: p.notes,
    createdAt: p.createdAt.toISOString(),
  };
}
